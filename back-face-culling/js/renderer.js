...
/**
 * renderer.js is a module for rendering coloured 3d quads to a <canvas> element.
 *
 * Usage:
 ...
 *
 *   r.Clear();
 *   r.DrawQuad([0,0,1, 0,1,1, 1,1,1, 1,0,1]); // no back-face culling
 *   r.DrawQuadWithCulling([0,0,1, 0,1,1, 1,1,1, 1,0,1]);
 *
 * Key functions:
 *   Clear
 *   DrawQuadWithCulling
